...
Gem::Specification.new do |spec|
  spec.name    = 'fluent-plugin-github-stats'
  spec.version = '0.1.0'
  spec.authors = ['Thomas Tych']
  spec.email   = ['thomas.tych@gmail.com']

  spec.summary       = 'fluentd plugin to generate github stats events.'
  spec.homepage      = 'https://gitlab.com/ttych/fluent-plugin-github-stats'
